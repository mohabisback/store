...
console.log('12345: host: ', host )
console.log('12345: user: ', PG_USER )
console.log('12345: password: ',  PG_PASS)
console.log('12345: dbName: ', dbName )
const startPgClient = async (): Promise<void> => {
  ...
  const sqlFiles = fs.readdirSync(path.resolve(__dirname, sqlDir), {withFileTypes: true})
