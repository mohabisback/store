...
import defaultTheme from '../globalStyles/themes/defaultTheme.js'
...
export const ExternalThemeReducer = {
  isReady: false,
  //state: null,
  getState: () => {console.error('ExternalThemeReducer is NOT ready')},
  dispatch: () => {console.error('ExternalThemeReducer is NOT ready')},
}
...
export const ThemeProvider = ({ children }) => {
  ...
  const providedValue = {
    ...
    setTheme: (theme) => {dispatch({type: 'SET_USER', payload: theme}); }, 
  }
